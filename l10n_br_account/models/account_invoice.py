...
class AccountMove(models.Model):
    ...
    def _compute_amount(self):
        # TODO: Ao chamar apenas o super ao inves de chamar o do objeto
        ...
        for move in self:
            ...
            for line in move.line_ids:
                ...
                if line.account_id.user_type_id.type in ("receivable", "payable"):
                    # O codigo original não faz o arredondamento
                    # o que parece estar errado.
                    round_curr = line.currency_id or self.env.ref("base.BRL")

                    # Residual amount.
                    total_to_pay += round_curr.round(line.balance)
                    total_residual += round_curr.round(line.amount_residual)
                    total_residual_currency += round_curr.round(
